...
class AppShell extends StatelessWidget {
  const AppShell({
    ...
    required this.nav,
    required this.body,
    this.title = 'Gonzalo García — Portfolio',
  });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: () => nav.scrollTo(context, 'projects'),
            child: const Text('Proyectos'),
          ),
          TextButton(
            onPressed: () => nav.scrollTo(context, 'experience'),
            child: const Text('Experiencia'),
          ),
          TextButton(
            onPressed: () => nav.scrollTo(context, 'resume'),
            child: const Text('Resume'),
          ),
          TextButton(
            onPressed: () => nav.scrollTo(context, 'contact'),
